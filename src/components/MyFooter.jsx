const MyFooter = () => (
    <footer className="container-lg" style={{ marginTop: 200 }}>
    ...
    <div className="row">
        <div className="col-6 col-md-4 col-lg-3 color-p-in-col">
    ...
    <div className="row">
        <p
        className="social-links"
        style={{ marginLeft: 10, marginTop: 20, fontSize: 11 }}
        >
